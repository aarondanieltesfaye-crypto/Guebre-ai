(function () {
  ...
  var I18N = {
    fr: {
      ...
      chips: [
        ...
        "Qui contacter à la vie scolaire ?"
      ]
    },
    ...
    en: {
      ...
      chips: [
        ...
        "Who should I ask at vie scolaire?"
      ]
    },
  ...
  var ARTICLES = [
    {
      ...
      date: {
        fr: "Calendrier LGM 2026-2027",
        en: "LGM calendar 2026-2027",
        am: "የLGM የዘመን ሰሌዳ 2026-2027"
      },

      summary: {
        fr: "La prérentrée des enseignants est le mardi 1er septembre. Les élèves reprennent le mercredi 2 septembre 2026.",
...

    {
      ...
      title: {
        fr: "Nouvel An éthiopien (Addis Amet)",
        en: "Ethiopian New Year (Addis Amet)",
        am: "አዲስ አመት (እንቁጣጣሽ)"
      },
      ...
      date: {
        ...
        am: "መስከረም 11 ሴፕቴምበር 2026"
      },

      summary: {
        fr: "Le lycée est fermé le 11 septembre 2026 pour le Nouvel An éthiopien.",
...

    {
      ...
      title: {
        fr: "Fête de la Croix (Meskel)",
        en: "Feast of the Cross (Meskel)",
        am: "የመስቀል በዓል (መስቀል)"
      },
  ...
  function renderUsage() {
    ...
    document.getElementById("usage-left").textContent =
      String(left);

    document.getElementById("usage-max").textContent =
      String(DAILY_LIMIT);

    document.getElementById("usage-fill").style.width =
      (left / DAILY_LIMIT) * 100 + "%";
    ...
    document.getElementById("usage-fr").textContent =
      left === 1
        ? "1 question restante aujourd'hui"
        : left + " questions restantes aujourd'hui";
    ...
    if (left === 0) {
      chatInput.placeholder = t().limitReached;
    }
  }
